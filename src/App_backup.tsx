...
function App() {
  ...
  const [dialogOpen, setDialogOpen] = useState(false)
      description: "A wonderful coffee tasting event in the heart of Paris",
      organizer: "Espresso Foundation"
    },
      city: "London",
      coordinates: [51.5074, -0.1278],
      status: "ongoing",
      description: "Celebrating the best of British coffee culture",
    }
  ];
  useEffect(() => {
  }, []);
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      case "upcoming":
        return <img src={upcomingIcon} alt="Upcoming" className="w-4 h-4" />
      case "ongoing":
        return <img src={ongoingIcon} alt="Ongoing" className="w-4 h-4" />
      case "ended":
        return <img src={endedIcon} alt="Ended" className="w-4 h-4" />
      default:
        return <img src={ongoingIcon} alt="Ongoing" className="w-4 h-4" />
    }
  }
      ...
      <div className="map-overlay legend-panel">
        ...
        <div className="space-y-2 text-xs">
          <div className="flex items-center gap-3">
            <img src={upcomingIcon} alt="Upcoming" className="w-7 h-7" />
            <span className="text-[#421f17] font-medium">Upcoming</span>
          </div>
          <div className="flex items-center gap-3">
            <img src={ongoingIcon} alt="Ongoing" className="w-7 h-7" />
            <span className="text-[#421f17] font-medium">Ongoing</span>
          </div>
          <div className="flex items-center gap-3">
            <img src={endedIcon} alt="Ended" className="w-7 h-7" />
