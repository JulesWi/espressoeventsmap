...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-md bg-[#fbeee4] text-[#421f17] border border-[#eacaae]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b px-3" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-10 w-full rounded-md bg-[#fbeee4] text-[#421f17] py-3 text-sm outline-none placeholder-[#eacaae] border-none focus:ring-2 focus:ring-[#eacaae] disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      {...props}
    />
