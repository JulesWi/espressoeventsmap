...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden text-[#fbeee4] md:block"
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            "relative w-[--sidebar-width] bg-[#421f17] text-[#fbeee4] border-r-2 border-[#eacaae] transition-[width] duration-200 ease-linear", 
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), "bg-[#421f17] text-[#fbeee4] border-[#eacaae] hover:bg-[#eacaae] hover:text-[#421f17]", className)}
        {...props}
      />
    )
